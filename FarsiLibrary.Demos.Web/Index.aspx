<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="FarsiLibrary.WebDemo.Index" %>
<%@ Register Assembly="FarsiLibrary.Web" Namespace="FarsiLibrary.Web.Controls" TagPrefix="fl" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>FarsiLibrary - Web Demos</title>
</head>
<body>
    ...
    <div style='width:70%; margin:0 auto'>
        ...
        <div style="text-align:center">
            <asp:Label ID="Label1" runat="server" Text="Farsi Library Web Controls. All rights reserved Hightech.IR" />
        </div>
    </div>
    </form>
</body>
